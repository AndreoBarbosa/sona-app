 ...
 * novamente" volta pra /conectar — a pessoa pode trocar a seleção (ex.:
 * desmarcar o banco que falhou) em vez de reencenar a mesma tentativa fadada
 * a falhar de novo; "Continuar sem conectar" segue pra Home sem travar o
 * usuário aqui.
 *
      ...
      <div className="app-scroll mx-auto flex h-screen max-w-mobile flex-col overflow-y-auto">
        ...
        <main className="flex flex-1 flex-col gap-8 px-4 pb-10 pt-3">
          ...
          <div className="mt-auto flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              <Button variant="primary" label="Tentar novamente" fullWidth onClick={() => router.push("/conectar")} />
              <Button variant="ghost" label="Continuar sem conectar" fullWidth onClick={() => router.push("/home")} />
            </div>
          </div>
        </main>
      </div>
